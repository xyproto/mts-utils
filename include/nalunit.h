 ...
 */
void set_show_nal_reading_details(nal_unit_context_p  context,
                                         int                 show)
{
 ...
 */
int build_nal_unit_context(ES_p                es,
 ...
 */
int nal_is_first_VCL_NAL(nal_unit_p   nal,
                                nal_unit_p   last)
{
 ...
 * Returns 0 if it succeeds, 1 if some error occurs.
 */
int setup_NAL_data(int         verbose,
                          nal_unit_p  nal)
{
 ...
 */
int find_next_NAL_unit(nal_unit_context_p  context,
                              int                 verbose,
                              nal_unit_p         *nal)
{
 ...
 */
int write_NAL_unit_as_ES(FILE       *output,
                                nal_unit_p  nal)
{
 ...
 * Returns 0 if all went well, 1 if something went wrong.
 */
int write_NAL_unit_as_TS(TS_writer_p tswriter,
                                nal_unit_p  nal,
                                uint32_t    video_pid)
{
 ...
 * Returns 0 if it succeeds, 1 if some error occurs.
 */
int remember_param_data(param_dict_p  param_dict,
                               uint32_t      param_id,
                               nal_unit_p    nal)
{
  int ii;
 ...
 */
int get_pic_param_data(param_dict_p pic_param_dict,
 ...
 * Returns 0 if it succeeds, 1 if the id is not recognised.
 */
int get_seq_param_data(param_dict_p seq_param_dict,
 ...
 * Returns 0 if it succeeds, 1 if some error occurs.
 */
int append_to_nal_unit_list(nal_unit_list_p  list,
                                   nal_unit_p       nal)
{
 ...
 * as well (this will be a Bad Thing if anywhere else is using them).
 */
void reset_nal_unit_list(nal_unit_list_p  list,
                                int              deep)
{
  if (list->array != NULL)
  {
 ...
 */
void free_nal_unit_list(nal_unit_list_p  *list,
                               int               deep)
{
  if (*list == NULL)
    return;
 ...
 */
void report_nal_unit_list(int    is_msg,
                                 char  *prefix,
