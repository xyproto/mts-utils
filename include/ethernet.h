...
#define ETHERNET_MAY_BE_IP(typeorlen)                                          \
  ((typeorlen) == 0x800 || (typeorlen) <= 0x5DC)
 ...
 */
int ethernet_packet_from_pcap(pcaprec_hdr_t *hdr, const uint8_t *data,
                              const uint32_t len, ethernet_packet_t *pkt,
