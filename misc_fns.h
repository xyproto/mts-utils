 ...
 */
extern void print_bits(int num_bits, byte value);
 ...
 */
extern void print_data(int is_msg, const char* name, const byte data[], int length, int max);
/*
 ...
 * if not all bytes were shown).
 */
extern void print_end_of_data(char* name, byte data[], int length, int max);
/*
