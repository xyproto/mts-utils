...
int main(int argc, char** argv)
{
    ...
    err = ps_to_ts(ps, output, pad_start, repeat_program_every, video_type, input_is_dvd,
        video_stream, audio_stream, want_ac3_audio, want_dolby_as_dvb, pmt_pid, pcr_pid, video_pid,
