...
// (void)printf("<<<MSG>>> %s", message); } static void
// print_message_to_stderr(const char* message) { (void)printf("<<<ERR>>> %s",
// message); } static void fprint_message_to_stdout(const char* format, va_list
// arg_ptr)
//{
//    printf("<<<MSG>>> ");
...
int main(int argc, char **argv) {
  ...
  printf("A fairly crude set of tests, mainly to check that nothing falls "
         "over.\n");
  printf(
      "For each set of tests, you should see 4 messages, all very similar.\n");
  ...
  // printf("---------------------------------------------\n");
  // err = redirect_output(
  //    print_message_to_stdout, print_message_to_stderr, nullptr,
  ...
  // printf("------------------------------------------------------------------\n");
  // printf("After that (expected) failure, all four messages should still
  // work\n");
  // printf("------------------------------------------------------------------\n");
  // print_msg("1. Printing a normal message\n");
  // print_err("2. Printing an error message\n");
