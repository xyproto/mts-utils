...
int ipv4_from_payload(const uint8_t *data, const uint32_t len,
                      ipv4_header_t *out_hdr, uint32_t *out_st,
                      uint32_t *out_len) {
  uint32_t cur_field;
...
int ipv4_udp_from_payload(const uint8_t *data, const uint32_t len,
                          ipv4_udp_header_t *out_hdr, uint32_t *out_st,
                          uint32_t *out_len) {
  uint32_t cur_field;
