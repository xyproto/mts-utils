 ...
 */
extern void report_ES_unit(int is_msg, ES_unit_p unit);
 ...
 */
extern void report_ES_unit_list(char* name, ES_unit_list_p list);
 ...
 * Returns 0 if all goes well, 1 if something goes wrong
 */
extern int decide_ES_file_video_type(
    int input, int print_dots, int show_reasoning, int* video_type);
#endif // _es_fns
