...
static int insert_packets(
    int file, int out_file, uint8_t* out_packet, int* packet_numbers, int n_pack)
{
...

    {
...

        {
...

            {
                ...
                uint8_t* out_packet = create_out_packet(out_string, strlen(out_string) + 1, pid);
